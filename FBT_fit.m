...
function [R] = FBT_fit(model, options,subject,doparallel)
...
%Configure data
[r] = FBT_config(model, options,subject);
% CMG edit
...
R.bf = bf;  %Contains estimates of the quantities necessary to compute Bayes  factors for model comparison.
