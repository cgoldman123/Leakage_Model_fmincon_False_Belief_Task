...
if dostats
    ...
    if PLOT
        ...
        plot(trials(self_indices), actual_probability(self_indices), 's-', 'DisplayName', 'Reported Emotion', 'Color', 'b');
        plot(trials(self_indices), predicted_probability(self_indices), 'd-', 'DisplayName', 'Predicted Emotion', 'Color', 'r');
        xlabel('Trial');
        ylabel('Emotion');
        title('Self Emotion');
        legend('show');
        ...
        hold on;
        other_indices = probe == 2; % Logical index for self probes
        plot(trials(other_indices), actual_probability(other_indices), 's-', 'DisplayName', 'Reported Emotion', 'Color', 'b');
        plot(trials(other_indices), predicted_probability(other_indices), 'd-', 'DisplayName', 'Predicted Emotion', 'Color', 'r');
        xlabel('Trial');
        ylabel('Emotion');
        title('Other Emotion');
        legend('show');
