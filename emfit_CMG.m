...
if dostats
    ...
    if PLOT
        ...
        subplot(2,1,1); % Create a subplot for self probes
        hold on;
        self_indices = probe == 1; % Logical index for self probes
        plot(trials(self_indices), truth(self_indices), 'o-', 'DisplayName', 'Ground Truth', 'Color', 'k');
        plot(trials(self_indices), actual_probability(self_indices), 's-', 'DisplayName', 'Actual Probability', 'Color', 'b');
        plot(trials(self_indices), predicted_probability(self_indices), 'd-', 'DisplayName', 'Predicted Probability', 'Color', 'r');
        xlabel('Trial');
        ylabel('Probability');
        title('Self Probes');
        legend('show');
        ...
        subplot(2,1,2); % Create a subplot for other probes
        hold on;
        other_indices = probe == 2; % Logical index for other probes
        plot(trials(other_indices), truth(other_indices), 'o-', 'DisplayName', 'Ground Truth', 'Color', 'k');
        plot(trials(other_indices), actual_probability(other_indices), 's-', 'DisplayName', 'Actual Probability', 'Color', 'b');
        plot(trials(other_indices), predicted_probability(other_indices), 'd-', 'DisplayName', 'Predicted Probability', 'Color', 'r');
        xlabel('Trial');
        ylabel('Probability');
        title('Other Probes');
        legend('show');
